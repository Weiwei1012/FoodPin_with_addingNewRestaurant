...
// define protocal for adding restaurant
...
class NewRestaurantController: UITableViewController, UITextFieldDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    var addDelegate: AddDataDelegate?   // pointer for add data
    
    var selectedImageName: String = ""  // image is type "String"
    ...
    //Activate when pushing "Enter", change to next line
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [UIImagePickerController.InfoKey : Any]) {
        ...
        if let url = info[UIImagePickerController.InfoKey.imageURL] as? URL {
            ...
            print(selectedImageName)  //for debug
        }
        
        dismiss(animated: true, completion: nil)
    }
    
    //add new restaurant save button function
